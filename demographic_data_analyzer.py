...
def calculate_demographic_data(print_data=True):
    ...
    average_age_men = df.loc[df['sex'] == 'Male', ['age']]['age'].mean().round(1)
    ...
    higher_education_rich = ((higher_education.value_counts()['>50K'] / higher_education.size) * 100).round(1)
    lower_education_rich = ((lower_education.value_counts()['>50K'] / lower_education.size) * 100).round(1)
    ...
    rich_percentage = ((num_min_workers.value_counts()['>50K'] / num_min_workers.size) * 100).round(1)
    ...
    # Get proportion of rich workers by country
    country_rich_percentage = country_salary.groupby(['native-country'], as_index=False).mean()
    # Decimal formatting of highest proportion of rich workers for any country
    highest_earning_country_p = (country_rich_percentage['salary'].max())

    highest_earning_country = country_rich_percentage.loc[country_rich_percentage['salary'] == highest_earning_country_p, 'native-country'].iat[0]
    highest_earning_country_percentage = (highest_earning_country_p * 100).round(1)
